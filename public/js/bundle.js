...
var AddPersonActions = function () {
  function AddPersonActions() {
    _classCallCheck(this, AddPersonActions);

    this.generateActions('addPersonSuccess', 'addPersonFail', 'updateName', 'updateEmail', 'invalidName', 'invalidEmail');
  }

  _createClass(AddPersonActions, [{
    key: 'addPerson',
    value: function addPerson(name, email) {
      ...
      $.ajax({
        ...
        _this.actions.addPersonSuccess(data.message);
      }).fail(function (jqXhr) {
        _this.actions.addPersonFail(jqXhr.responseJSON.message);
      });
    }
  }]);

  return AddPersonActions;
}();

exports.default = _alt2.default.createActions(AddPersonActions);
...
},{"../alt":10}],6:[function(require,module,exports){
'use strict';
...
var PersonListActions = function () {
  function PersonListActions() {
    _classCallCheck(this, PersonListActions);

    this.generateActions('getPeopleSuccess', 'getPeopleFail');
  }

  _createClass(PersonListActions, [{
    key: 'getPeople',
    value: function getPeople(payload) {
      var _this = this;

      var url = '/api/people';
      var params = { action: 'none' };

      $.ajax({ url: url, data: params }).done(function (data) {
        _this.actions.getPeopleSuccess(data);
      }).fail(function (jqXhr) {
        _this.actions.getPeopleFail(jqXhr);
      });
    }
  }]);

  return PersonListActions;
}();

exports.default = _alt2.default.createActions(PersonListActions);

},{"../alt":10}],9:[function(require,module,exports){
'use strict';
...
},{"../actions/AddCharacterActions":1,"../stores/AddCharacterStore":22,"react":"react"}],12:[function(require,module,exports){
'use strict';
...
var _AddPersonStore = require('../stores/AddPersonStore');

var _AddPersonStore2 = _interopRequireDefault(_AddPersonStore);

var _AddPersonActions = require('../actions/AddPersonActions');

var _AddPersonActions2 = _interopRequireDefault(_AddPersonActions);
...
var AddPerson = function (_React$Component) {
  ...
  function AddPerson(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AddPerson).call(this, props));

    _this.state = _AddPersonStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    return _this;
  }
  ...
  _createClass(AddPerson, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _AddPersonStore2.default.listen(this.onChange);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _AddPersonStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    value: function onChange(state) {
    ...
    value: function handleSubmit(event) {
      ...
      if (!name) {
        _AddPersonActions2.default.invalidName();
        this.refs.nameTextField.getDOMNode().focus();
      }

      if (!email) {
        _AddPersonActions2.default.invalidEmail();
      }

      if (name && email) {
        _AddPersonActions2.default.addPerson(name, email);
      }
    }
  }, {
    key: 'render',
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'nameTextField', value: this.state.name,
                      onChange: _AddPersonActions2.default.updateName, autoFocus: true })
                  ),
                  _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'emailTextField', value: this.state.email,
                      onChange: _AddPersonActions2.default.updateEmail }),
                    _react2.default.createElement(
                      'span',
                      { className: 'help-block' },
                      this.state.helpBlock
...
},{"../actions/AddPersonActions":2,"../stores/AddPersonStore":23,"react":"react"}],13:[function(require,module,exports){
'use strict';
...
},{"./Footer":16,"./Navbar":18,"react":"react"}],14:[function(require,module,exports){
'use strict';
...
},{"../actions/CharacterActions":3,"../stores/CharacterStore":25,"react":"react"}],15:[function(require,module,exports){
'use strict';
...
},{"../actions/CharacterListActions":4,"../stores/CharacterListStore":24,"react":"react","react-router":"react-router","underscore":"underscore"}],16:[function(require,module,exports){
'use strict';
...
},{"../actions/FooterActions":5,"../stores/FooterStore":26,"react":"react","react-router":"react-router"}],17:[function(require,module,exports){
'use strict';
...
},{"../actions/HomeActions":6,"../stores/HomeStore":27,"react":"react","react-router":"react-router","underscore":"underscore"}],18:[function(require,module,exports){
'use strict';
...
},{"../actions/NavbarActions":7,"../stores/NavbarStore":28,"react":"react","react-router":"react-router"}],19:[function(require,module,exports){
'use strict';
...
var _PersonListStore = require('../stores/PersonListStore');

var _PersonListStore2 = _interopRequireDefault(_PersonListStore);

var _PersonListActions = require('../actions/PersonListActions');

var _PersonListActions2 = _interopRequireDefault(_PersonListActions);
...
var PersonList = function (_React$Component) {
  _inherits(PersonList, _React$Component);

  function PersonList(props) {
    _classCallCheck(this, PersonList);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PersonList).call(this, props));

    _this.state = _PersonListStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    return _this;
  }
  ...
  _createClass(PersonList, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _PersonListStore2.default.listen(this.onChange);
      _PersonListActions2.default.getPeople(this.props.params);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _PersonListStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'componentDidUpdate',
    value: function componentDidUpdate(prevProps) {
    ...
    key: 'render',
    value: function render() {
      var PeopleList = this.state.people.map(function (person, index) {
        return _react2.default.createElement(
          'div',
          { key: person.email, className: 'list-group-item animated fadeIn' },
          _react2.default.createElement(
            'div',
            { className: 'media' },
            _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'pull-left thumb-lg' },
              _react2.default.createElement(_reactRouter.Link, { to: '/people/' + person.email })
            ),
            _react2.default.createElement(
              'div',
              { className: 'media-body' },
...
},{"../actions/PersonListActions":8,"../stores/PersonListStore":29,"react":"react","react-router":"react-router","underscore":"underscore"}],20:[function(require,module,exports){
'use strict';
...
},{"../actions/StatsActions":9,"../stores/StatsStore":30,"react":"react"}],21:[function(require,module,exports){
'use strict';
...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouter.Route, { path: '/addperson', component: _AddPerson2.default }),
  _react2.default.createElement(_reactRouter.Route, { path: '/listpeople', component: _PersonList2.default }),
...
},{"./components/AddCharacter":11,"./components/AddPerson":12,"./components/App":13,"./components/Character":14,"./components/CharacterList":15,"./components/Home":17,"./components/PersonList":19,"./components/Stats":20,"react":"react","react-router":"react-router"}],22:[function(require,module,exports){
'use strict';
...
},{"../actions/AddCharacterActions":1,"../alt":10}],23:[function(require,module,exports){
'use strict';
...
var AddPersonStore = function () {
  function AddPersonStore() {
    _classCallCheck(this, AddPersonStore);

    this.bindActions(_AddPersonActions2.default);
    this.name = '';
    this.email = '';
    this.helpBlock = '';
    this.nameValidationState = '';
  ...
  _createClass(AddPersonStore, [{
    key: 'onAddPersonSuccess',
    value: function onAddPersonSuccess(successMessage) {
      this.nameValidationState = 'has-success';
      this.helpBlock = successMessage;
    }
  }, {
    key: 'onAddPersonFail',
    value: function onAddPersonFail(errorMessage) {
      this.nameValidationState = 'has-error';
      this.helpBlock = errorMessage;
    }
  }, {
  ...
  return AddPersonStore;
}();

exports.default = _alt2.default.createStore(AddPersonStore);

},{"../actions/AddPersonActions":2,"../alt":10}],24:[function(require,module,exports){
'use strict';
...
},{"../actions/CharacterListActions":4,"../alt":10}],25:[function(require,module,exports){
'use strict';
...
},{"../actions/CharacterActions":3,"../alt":10,"underscore":"underscore"}],26:[function(require,module,exports){
'use strict';
...
},{"../actions/FooterActions":5,"../alt":10}],27:[function(require,module,exports){
'use strict';
...
},{"../actions/HomeActions":6,"../alt":10}],28:[function(require,module,exports){
'use strict';
...
},{"../actions/NavbarActions":7,"../alt":10}],29:[function(require,module,exports){
'use strict';
...
var PersonListStore = function () {
  function PersonListStore() {
    _classCallCheck(this, PersonListStore);

    this.bindActions(_PersonListActions2.default);
    this.people = [];
  }

  _createClass(PersonListStore, [{
    key: 'onGetPeopleSuccess',
    value: function onGetPeopleSuccess(data) {
      this.people = data;
    }
  }, {
    key: 'onGetPeopleFail',
    value: function onGetPeopleFail(jqXhr) {
      toastr.error(jqXhr.responseJSON.message);
    }
  }]);
...
exports.default = _alt2.default.createStore(PersonListStore);

},{"../actions/PersonListActions":8,"../alt":10}],30:[function(require,module,exports){
'use strict';
...
},{"../actions/StatsActions":9,"../alt":10,"underscore":"underscore"}],31:[function(require,module,exports){
...
},{"_process":48,"warning":49}],37:[function(require,module,exports){
'use strict';
...
},{"./Actions":34,"./DOMStateStorage":36,"./DOMUtils":37,"./ExecutionEnvironment":38,"./createDOMHistory":40,"./parsePath":45,"_process":48,"invariant":47}],40:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./DOMUtils":37,"./ExecutionEnvironment":38,"./createHistory":41,"_process":48,"invariant":47}],41:[function(require,module,exports){
...
},{"./extractPath":44,"_process":48,"warning":49}],46:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":48,"warning":49}],47:[function(require,module,exports){
(function (process){
/**
...
},{"_process":48}],50:[function(require,module,exports){
'use strict';
...
},{"./routes":21,"history/lib/createBrowserHistory":39,"react":"react","react-dom":"react-dom","react-router":"react-router"}]},{},[50])
